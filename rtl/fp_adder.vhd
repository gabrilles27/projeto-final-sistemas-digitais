...
-- fp_adder.vhd
--
-- Somador de ponto flutuante simplificado de 13 bits, transcrito sem alteracao
-- de Pong P. Chu, "FPGA Prototyping by VHDL Examples", secao 3.7.4,
-- Listing 3.19 - "Simplified floating-point adder".
--
-- Referencia da Etapa 1: e contra este codigo que os testbenches medem o
-- comportamento do algoritmo original.
--
-- A adaptacao para a DE10-Lite, com as correcoes, esta em
